...
public class BeyondAltarBlockEntityRenderer implements BlockEntityRenderer<BeyondAltarBlockEntity> {
    public BeyondAltarBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }
    @Override
    public void render(BeyondAltarBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        ...
        pPoseStack.mulPose(Vector3f.YP.rotationDegrees(((float) (level.getGameTime() % 360L + pPartialTick))));
