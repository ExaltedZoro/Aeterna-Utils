...
public class GatewayAltarBlockEntityRenderer implements BlockEntityRenderer<GatewayAltarBlockEntity> {
    public GatewayAltarBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }
    @Override
    public void render(GatewayAltarBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
